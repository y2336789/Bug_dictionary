...
public class BugAdapter extends RecyclerView.Adapter {

    String insectKey = null;
    ArrayList<Bug> bugs;
    Context context;

    public BugAdapter(ArrayList<Bug> items, Context context) {
        this.bugs = items;
        ...
        public VH(@NonNull View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent intent = new Intent(context, BugItemActivity.class);
